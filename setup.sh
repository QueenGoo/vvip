...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/QueenGoo/vvip/main/tai > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/QueenGoo/vvip/main/tai | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/QueenGoo/vvip/main/tai | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo -e "$white\033[0;34m+-----------------------------------------+${NC}"
sleep 1 
wget -q https://raw.githubusercontent.com/QueenGoo/vvip/main/jembot.sh && chmod +x jembot.sh && ./jembot.sh
#install ssh-vpn
echo -e "$white\033[0;34m+-----------------------------------------+${NC}"
echo -e " \E[41;1;39m          ? Install SSH / WS ?           \E[0m$NC"
echo -e "$white\033[0;34m+-----------------------------------------+${NC}"
sleep 1
wget -q https://raw.githubusercontent.com/QueenGoo/vvip/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#install ins-xray
echo -e "$white\033[0;34m+-----------------------------------------+${NC}"
echo -e " \E[41;1;39m            ? Install Xray ?             \E[0m$NC"
echo -e "$white\033[0;34m+-----------------------------------------+${NC}"
sleep 1 
wget -q https://raw.githubusercontent.com/QueenGoo/vvip/main/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
wget -q -O /usr/bin/menu-ssh "https://raw.githubusercontent.com/QueenGoo/vvip/main/menu-ssh.sh"
...
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/QueenGoo/vvip/main/usernew.sh"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/QueenGoo/vvip/main/menu.sh"
